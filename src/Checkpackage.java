...
public class Checkpackage  extends JFrame {
    ...
    Checkpackage() {
     ...
     String[] package1= {"GOLD PACKAGE","5 Days and 6 Nights", "Airport Assistance","Full Day 3 Island Cruise","Daily Buffet","Soft Drinks Free","English Speaking Guide","Full day 3 Island Cruise","Book Package","winter Special","22000 Tk","Package1.jpg"};
     ...
     String[] package3= {"BRONZE PACKAGE","2 Days and 3 Nights","Return Airfare","Free Clubing,Horse Riding","Soft Drinks Free","Free Lunch and Dinner","BBQ Dinner","Book Now","Spring Special","River Rafting","14000 Tk","Package3.jpg"};
