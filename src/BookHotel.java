...
public class BookHotel extends JFrame implements ActionListener{
    ...
    BookHotel(String username){
        ...
        JLabel lbldays = new JLabel("No.of Datys");
        ...
        if(ae.getSource() == checkprice){
            ...
            try{
                ...
                c.s.executeUpdate("insert into bookhotel values('"+labelusername.getText()+"'," +
                        "'"+chotel.getSelectedItem()+"','"+tfpersons.getText()+"','"+tfdays.getText()+"','"+ cac.getSelectedItem()+"','"+cfood.getSelectedItem()+"','"+labelid.getText()+"'," +
                        "'"+labelnumber.getText()+"','"+labelphone.getText()+"','"+labelprice.getText()+"')");
                JOptionPane.showMessageDialog(null,"Horel Booked Successfully");
